...
from ultralytics.nn.modules import (poolformer_s12,poolformer_s24,poolformer_s36,poolformer_m36,
                                    AIFI,
                                    C1,
                                    C2,
                                    C3,
    ...
    for i, (f, n, m, args) in enumerate(d["backbone"] + d["head"]):  # from, number, module, args
        ...
        if m in (
            ...
            if m is HGBlock:
                ...
                n = 1
        elif m in (poolformer_s12,poolformer_s24,poolformer_s36,poolformer_m36,):
            print(args)
            m = m(*args)
            c2 = m.channels
            print(m.channels)
